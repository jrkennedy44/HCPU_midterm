...
def main():
    ...
    # launch Censor on each chunk in query_dir
    launcher = Launcher.CensorLauncher( jobdb, query_dir, subject_db, paramCEN, cdir, tmpdir, job_table, queue, groupid )
    launcher.run()
