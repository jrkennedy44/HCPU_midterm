...
def main():
    ...
    # launch TRF in parallel on all the fasta files in 'query_dir'
    launcher = Launcher.TRFLauncher( jobdb, query_dir, paramTRF, cdir, tmpdir, job_table, queue, groupid )
    launcher.run()
